        ...
        <script>
            layui.use(['form','laydate','laypage','layer','upload'],function(){
                ...
                layui.showInfo = function(id){
                    layui.save("查看邮箱通知",id);
                }

                //编辑
                layui.edit = function(id){
                    layui.save("编辑邮箱通知",id)
                }
                ...
                layui.del = function(id){
                    layer.msg("您是否确定要删除该邮箱通知！", {
                        btn: ['确定', '取消'],
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/ddEmail/delById?id="+id;
                        }
                    });
                }
            });
